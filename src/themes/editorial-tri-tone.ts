...
export const editorialTriTone: Theme = {
  ...
  css: {
    background: "#f5efe0",
    textColor: "#3d1520",
    fontImports: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,200;12..96,400;12..96,600;12..96,700;12..96,800&family=Instrument+Serif:ital@0;1&display=swap",
