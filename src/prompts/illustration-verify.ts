import type { MultimodalContent } from "../llm.js";
...
export function illustrationVerifyUser(
  ...
  return [
    {
      type: "text",
      text: `This is a composited infographic slide titled "${slideTitle}". An illustration has been overlaid on the rendered slide. Evaluate whether the result looks good.\n\nRespond with JSON:\n{ "ok": true/false, "issues": "description of issues if any" }`,
    },
    {
      type: "image_url",
